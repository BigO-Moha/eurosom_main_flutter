...
class EurosomEvent with _$EurosomEvent {
  ...
  const factory EurosomEvent.payEvc(String payment_method, String number,
      double price, pm.Datum pricing_model, int app_id) = _PayEvc;
  const factory EurosomEvent.payEdahab(String payment_method, String number,
      double price, pm.Datum pricing_model, int app_id) = _PayEDahab;
  const factory EurosomEvent.payPW(String payment_method, String number,
      double price, pm.Datum pricing_model, int app_id) = _PayPW;
